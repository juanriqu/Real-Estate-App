...
import com.example.dttassesmentandroid.databinding.FragmentDetailedHouseBinding
...
class DetailedHouseFragment : Fragment(), OnMapReadyCallback {
    ...
    private lateinit var houseDistance: String
    private lateinit var mapView: MapView
    private lateinit var map: GoogleMap
    private var argHouseId = "houseId"
    private var argHouseDistance = "houseDistance"
    ...
    private fun configFragmentArguments() {
        arguments?.let {
            ...
            houseDistance = it.getString(argHouseDistance).toString()
        }
    }
